...
$fetched_new_pan = $querys->select_last_inserted_new_pan_row();
...
<head>
    ...
    <title>New Pan Apply Success</title>
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <div class="card shadow-lg">
                ...
                while ($new_pan_row = $fetched_new_pan->fetch_assoc()) { ?>
                    <h2 class="text-primary" style="font-weight: 800;">
                        <?php echo $new_pan_row['new_pan_receipt_number']; ?>
                    </h2>
                    <?php
                }
                ?>
